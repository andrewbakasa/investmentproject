        ...
        $("#tankdesignparameters_section").children(".view-section").each(function() {
            ...
            if (attr == "my_tankdesignparameters_section") {  
                html_lead=`<div class="table-responsive row">
                            <div style="flex: 50%;">
                                <table id="tankdesignparametersTableA" class="table table-striped" >
                                    <thead>
                                    </thead>
                                    <tbody id="tankdesignparametersA-table-tbody">`    
                                    const objA = {
                                ...
                                html_body_2 =`<div style="flex: 50%;">
                                                <table id="tankdesignparametersTableB" class="table table-striped" >
                                                    <thead>
                                                    </thead>
                                                    <tbody id="tankdesignparametersB-table-tbody">`
                                            const objB = {
                    ...
                    <a class="model-edit show-form-update" href="#" data-url="/fish/update_model_tankdesignparameters_ajax/${data[model_or_data].id}/" 
                ...
                url=`/fish/update_model_tankdesignparameters_ajax/${data[model_or_data].id}/`
    ...
    function updatetankdesignparametersTable(data){
            ...
            $.each(obj, function(key, value) {
                ...
                for (let i = 0; i < tables.length; i++) {
                    ...
                    $(`#tankdesignparametersTable${tables[i]} #tankdesignparameters-`+ value).children(".tankdesignparametersData").each(function() {
                        var attr = $(this).attr("name");
                        if (attr == value) {
