...
var user_loc_x = JSON.parse(document.getElementById('user-x-data').textContent);
var user_loc_y = JSON.parse(document.getElementById('user-y-data').textContent);
...
//   console.log(start)
//   //function...
//   user_loc_x=-1.756111,user_loc_y=17.553711
//   pointsA = [
//     [parseFloat(user_loc_x), parseFloat(user_loc_y), "view position Changed"],
//   ];
