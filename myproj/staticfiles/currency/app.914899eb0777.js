...
function update_layer(map,i_layer, props,newContent,newtooltipContent,){
    ...
    if (nonEmptyTaglist(props.tag_source_target)){
        ...
        }else if (props.suitor.includes(user_name) && (props.already_matched ==false)) {
        ...
        if (props.suitor.includes(user_name) && (props.already_matched ==false)) {
        ...
        L.geoJson(data, {
          ...
          onEachFeature: function onEachFeature(feature, layer) {
           ...
           $(a_html).bind("mouseover",function(){                    
            ...
            layer.bindTooltip(t);
            layer._id = props.uid
            update_layer(map, layer, props,content,newtooltipContent)
