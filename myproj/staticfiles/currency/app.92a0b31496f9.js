         ...
         // console.log(x)
          ...
          if (tag_source_username.length>0 || tag_target_username.length>0){
              ...
              if (props.matching_partner ==true){
                  ...
                  curr_tooltipContent = '<small>' + props.offer_symbol + nFormatter(props.value,2) +" @" + nFormatterdist(props.distance,1)+ "</small>"
                ...
                flash_message(i_layer,newtooltipContent,curr_tooltipContent)
                  ...
                  curr_tooltipContent = '<small> Your are tracking @' + nFormatterdist(props.distance,1)+ "</small>"
                  flash_message(i_layer,newtooltipContent,curr_tooltipContent)
