      ...
      if (i_layer._id == props.uid){
          ...
          if(i_layer.options && i_layer.options.pane === "markerPane") {
            ...
            if (nonEmptyTaglist(props.tag_source_target)){
                ...
                if ((props.matching_partner ==true) && loggeduserIsInSourceList(props.tag_source_target, user_name)){
                    // match here
                    /* 
                ...
                }else if (props.suitor.split(",").includes(user_name) && (props.matching_partner ==false)) {
                ...
                }else if (props.matching_partner ==false) {
                    //matching happens on target but is not caused by current user
                    // This node is should not be availabe
                ...
                if (props.suitor.split(",").includes(user_name) && (props.matching_partner ==false)) {
