  ...
  return item ? (num / item.value).toFixed(digits).replace(rx, "$1") + item.symbol : "0";
    ...
    if (!navigator.geolocation){
      ...
      setInterval(()=> {
        ...
        $('#total_projects_searched').text("Your Location Lat: " + user_loc_x + " Long: " + user_loc_y)
      }, 15000)
    }
...
function getPosition(position){
  ...
  if (get_transition_metre(10)){// at every 10 metre refresh
    myScript()
  }
