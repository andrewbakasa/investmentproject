...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='InvestmentParameterOptions',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('option_name', models.CharField(max_length=200)),
                ('option_heading', models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            name='FeedlotDesignParameters',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('num_of_feedlots', models.IntegerField(default=1)),
                ('length', models.DecimalField(decimal_places=2, default=7.5, max_digits=10)),
                ('width', models.DecimalField(decimal_places=2, default=7.5, max_digits=10)),
                ('sqm', models.DecimalField(decimal_places=2, default=2500, max_digits=10)),
                ('pen_area', models.DecimalField(decimal_places=2, default=2500, max_digits=10)),
                ('sqm_per_cattle', models.DecimalField(decimal_places=2, default=10, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cattle_per_pen_per_year', models.IntegerField()),
                ...
                ('weight_at_purchase', models.DecimalField(decimal_places=2, max_digits=10)),
