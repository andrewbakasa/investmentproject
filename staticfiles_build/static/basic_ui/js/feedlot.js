...
function addfeedlotdesignparametersTable(data){
    ...
    $("#feedlotdesignparameters_section").children(".view-section").each(function() {
        ...
        if (attr == "my_feedlotdesignparameters_section") { 
            ...
            html_lead=`<div class="table-responsive row">
                            <div style="flex: 50%;">
                                <table id="feedlotdesignparametersTableA" class="table table-striped" >
                                    <thead>
                                    </thead>
                                    <tbody id="feedlotdesignparametersA-table-tbody">`
                                        const objA = {
                                            length: 'length',
                                            width: 'width',
                                        // pen_area: 'pen_area',
                                ...
                                html_body_2 =`<div style="flex: 50%;">
                                                <table id="feedlotdesignparametersTableB" class="table table-striped" >
                                                    <thead>
                                                    </thead>
                                                    <tbody id="feedlotdesignparametersB-table-tbody">`
                                            const objB = {
                ...
                <a class="model-edit show-form-update" href="#" data-url="/beef/update_model_feedlotdesignparameters_ajax/${data[model_or_data].id}/" 
            ...
            a_html =html_lead + html_body_1 + html_trail_1 + html_body_2 + html_trail_2 + html_trail_3
            $(this).html(a_html)
            //prepare for updating
            
            url=`/beef/update_model_feedlotdesignparameters_ajax/${data[model_or_data].id}/`
        ...
        $.each(obj, function(key, value) {
            //console.log(value);
             ...
             for (let i = 0; i < tables.length; i++) {
                $(`#feedlotdesignparametersTable${tables[i]} #feedlotdesignparameters-`+ value).children(".feedlotdesignparametersData").each(function() {
                    var attr = $(this).attr("name");
                    if (attr == value) {
